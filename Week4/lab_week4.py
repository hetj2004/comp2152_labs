...
print("You got the loots, o organize your belt alphabetically:")
belt.sort()
print("Your belt: ", belt)
...
input("Roll for thhe Monster's Magic Power (Press Enter)")
power_roll = random.choice(["Fire Magic", "Frezzing Time", "Super Hearing"])
